...
test.describe('PDF Editor 기능 테스트', () => {
  ...
  test('2. PropertiesPanel에서 X, Y, Width, Height 편집', async ({ page }) => {
    ...
    const xInput = page.locator('input[type="number"]').filter({ has: page.locator('label:has-text("X")') }).first();
    ...
    const yInput = page.locator('label:has-text("Y")').locator('..').locator('input[type="number"]');
    ...
    const widthInput = page.locator('label:has-text("너비")').locator('..').locator('input[type="number"]');
    ...
    const heightInput = page.locator('label:has-text("높이")').locator('..').locator('input[type="number"]');
  ...
  test('3. strokeWidth 슬라이더 기능', async ({ page }) => {
    ...
    // 선 굵기 슬라이더 찾기
    const strokeWidthSlider = page.locator('label:has-text("선 굵기")').locator('..').locator('input[type="range"]');
    ...
    const strokeWidthNumber = page.locator('label:has-text("선 굵기")').locator('..').locator('input[type="number"]');
  ...
  test('4. 색상 변경 기능', async ({ page }) => {
    ...
    // 테두리 색상 버튼 클릭
    const strokeColorButton = page.locator('label:has-text("테두리 색상")').locator('..').locator('button');
